 ...
 *    @param  c
 *            Raspberry pin connected to TLC5947 clock pin
 *    @param  d
 *            Raspberry pin connected to TLC5947 data pin
 *    @param  l
 *            Raspberry pin connected to TLC5947 latch pin
 */
...
void Adafruit_TLC5947::setLED(uint16_t lednum, uint16_t r, uint16_t g,
  ...
  // Convert input from 8bit to 12bit for set PWM
  float f_ratio_12bit_to_8bit = 16.058823;  // 4095/255 = ~16.058823
  r *= f_ratio_12bit_to_8bit;
  b *= f_ratio_12bit_to_8bit;
  g *= f_ratio_12bit_to_8bit;
